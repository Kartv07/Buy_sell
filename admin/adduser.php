...
?>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header text-center card-header-warning">
                ...
                <div class="card-body">
                  <form action="" method="post" name="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Hostel</label>
                    ...
                    <button type="submit" name="btn_save" id="btn_save" class="btn btn-warning pull-right">Update User</button>
