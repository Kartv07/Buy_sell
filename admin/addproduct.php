                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="">
                        ...
                        <input type="file" name="picture" required class="btn btn-fill btn-warning" id="picture" >
                      </div>
                    </div>
                     <div class="col-md-12">
                      <div class="form-group">
          ...
          <div class="col-md-5">
            <div class="card">
              ...
              <div class="card-footer">
                  <button type="submit" id="btn_save" name="btn_save" required class="btn btn-fill btn-warning">Update Product</button>
              </div>
            </div>
          </div>
