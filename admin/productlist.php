...
?>
	...
	<a class=" btn btn-warning" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <a class=' btn btn-warning' href='clothes_list.php?product_id=$product_id&action=delete'>Delete</a>
                        </td></tr>";
                        }
